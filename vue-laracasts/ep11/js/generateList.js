class RandomList {
    ...
    tags = ['math', 'science', 'work', 'tech', 'life'];
    ...
    randomTaskList = (
        ...
        for (let index = start; index < end; index++) {
            const n = this.random(this.completed.length); // completed: 0 = false, 1 = true
            const t = this.random(this.tags.length); // choices a random tag from tags array property
            list.push({
